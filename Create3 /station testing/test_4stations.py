# test_4stations.py
'''
Run this code to test your station's functionality without using the Create3.
This code reads orders from the Airtable UI table and functions the exact same 
way as our actual Create3 code. Once this script is running, place an order in 
the airtable and run your station's script. It will print our statements to 
terminal to indicate what the create will be doing in the real demo. 

Note: make sure this script is in the same folder as your station's code and the
airtable_module.py file. 
